...
/** batchAddQuestionsToQuestionBank POST /api/questionBankQuestion/add/batch */
export async function batchAddQuestionsToQuestionBankUsingPost(
...
/** batchRemoveQuestionsFromQuestionBank POST /api/questionBankQuestion/remove/batch */
export async function batchRemoveQuestionsFromQuestionBankUsingPost(
